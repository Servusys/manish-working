...
function ArchiveSecurityQuestion() {
  ...
  useEffect(() => {
    axios
      .get(
        `${process.env.REACT_APP_BASE_URL}types?type=securityQuestion&category=archive`
      )
  ...
  const handleClick = (id) => {
    axios
      .get(
        `${process.env.REACT_APP_BASE_URL}users/getArchiveHistory?type=securityQuestion&productId=${id}`
      )
      .then((res) => {
  ...
  const handleRestore = (data, id) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_BASE_URL}types/restore?type=securityQuestion`,
        {
          id,
          archiveId: data?.id,
        }
              ...
              <div className="row g-3">
                <div className="col-md-6 col-sm-12">
                  <h2 className="m-0 fs-5">
                    <ToggleNavBar />
                    Archive Security Question Type
                  </h2>
...
export default ArchiveSecurityQuestion;
