...
function ArchiveSex() {
  ...
  useEffect(() => {
    axios
      .get(`${process.env.REACT_APP_BASE_URL}types?type=sex&category=archive`)
  ...
  const handleRestore = (data, id) => {
    // alert(id);
    axios
      .put(`${process.env.REACT_APP_BASE_URL}types/restore?type=sex`, {
        id,
        archiveId: data?.id,
      })
      .then((res) => {
        ...
        axios
          .get(
            `${process.env.REACT_APP_BASE_URL}types?type=sex&category=archive`
          )
          .then((res) => {
  ...
  const handleClick = (id) => {
    axios
      .get(
        `${process.env.REACT_APP_BASE_URL}users/getArchiveHistory?type=sex&productId=${id}`
      )
      .then((res) => {
