...
function SecurityQuestionType() {
  ...
  const fetchData = async () => {
    axios
      .get(`${process.env.REACT_APP_BASE_URL}types?type=securityQuestion&category=all`)
      .then(function (res) {
  ...
  const handleClick = (e) => {
    ...
    if (row.Type === "") {
      ...
      axios
        .post(`${process.env.REACT_APP_BASE_URL}types?type=securityQuestion`, row)
        .then((res) => {
  ...
  const handleDeleteClick = (id) => {
    axios
      .put(`${process.env.REACT_APP_BASE_URL}types/archive?type=securityQuestion`, {
        // ...selectedItem,
        id,
      })
      .then((res) => {
  ...
  const handleUpdateProvider = () => {
    ...
    axios
      .put(`${process.env.REACT_APP_BASE_URL}types?type=securityQuestion`, {
        ...selectedItem,
        Type: editedType,
      })
      .then((res) => {
