...
function TitleType() {
  ...
  const fetchData = async () => {
    axios
      .get(`${process.env.REACT_APP_BASE_URL}types?type=title&category=all`)
      .then(function (res) {
  ...
  const handleClick = (e) => {
    ...
    if (row.Type === "") {
      ...
      axios
        .post(`${process.env.REACT_APP_BASE_URL}types?type=title`, row)
        .then((res) => {
  ...
  const handleDeleteClick = (id) => {
    axios
      .put(`${process.env.REACT_APP_BASE_URL}types/archive?type=title`, {
        // ...selectedItem,
        id,
      })
      .then((res) => {
        ...
        axios
          .get(
            `${process.env.REACT_APP_BASE_URL}types?type=title&category=all`
          )
          .then((res) => {
            // console.log(res.data.data);
            setData(res?.data?.data);
  ...
  const handleUpdateProvider = () => {
    ...
    axios
      .put(`${process.env.REACT_APP_BASE_URL}types?type=title`, {
        ...selectedItem,
        Type: editedType,
      })
      .then((res) => {
                ...
                <div className="col-12">
                  <div className="card">
                    <div className="card-header d-flex justify-content-between">
                      <h6 className="card-title">Title Type</h6>
                    </div>
      ...
      >
        <div class="custom_content-wrapper tw-w-[50%]">
          ...
          <header class="custom_modal-header">
            <h2>Edit Title Type</h2>
          </header>
          <div className="tw-w-[100%]">
            <div className="col-12">
              <label className="form-label">Edit Title Type</label>
              <input
                type="text"
                value={editedType}
