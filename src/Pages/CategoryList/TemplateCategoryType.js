...
function TemplateCategoryType() {
  ...
  const handleClick = (e) => {
    ...
    if (row.Type === "") {
      ...
      axios
        .post(`${process.env.REACT_APP_BASE_URL}types?type=template`, row)
        .then((res) => {
  ...
  const handleDeleteClick = (id) => {
    axios
      .put(`${process.env.REACT_APP_BASE_URL}types/archive?type=template`, {
        // ...selectedItem,
        id,
      })
      .then((res) => {
  ...
  const handleUpdateProvider = () => {
    ...
    axios
      .put(`${process.env.REACT_APP_BASE_URL}types?type=template`, {
        ...selectedItem,
        Type: editedType,
      })
      .then((res) => {
                ...
                <div className="col-12">
                  <div className="card">
                    <div className="card-header d-flex justify-content-between">
                      <h6 className="card-title">Template Category Type</h6>
                    </div>
                    <div className="card-body">
                      <div className="row">
                        <div className="col-sm-6 col-md-4">
                          <label className="form-label">
                            Add Template Category Type
                          </label>
                          <input
                            type="text"
                            name="Type"
      ...
      >
        <div class="custom_content-wrapper tw-w-[50%]">
          ...
          <header class="custom_modal-header">
            <h2>Edit Template Category Type</h2>
          </header>
          <div className="tw-w-[100%]">
            <div className="col-12">
              <label className="form-label">Edit Template Category Type</label>
              <input
                type="text"
                value={editedType}
...
export default TemplateCategoryType;
