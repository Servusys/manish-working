...
const Chart6 = (props) => {
  ...
  [props?.position,props?.BackgroundColor,props?.FontSize,props?.YAxis,props?.XAxis,props?.Color,props?.DataLabels,props?.LegendDisplay,props?.LegendTextColor,data]);
