...
import "../TemplateConfiguration/template.css";
...
function AddTemplateContent() {
  ...
  const [TopBg, setTopBg] = useState('#fff');
  ...
  const [rowMain, setRowMain] = useState({
    TemplateName: "",
    Description: "",
    TemplateBackgroundTheme: "#ffffff",
    pagetitleColorC: "#ffffff",
    TemplateCat: "",
  });
  ...
  const openrChart2 = (boxId, cid, bid) => {
    ...
    setChartTypeData(containers[cid].boxes[bid].boxChartType);
  ...
  const handleChangeMatrics = (subvalue) => {
    ...
    // axios
    //   // .get(`https://www.servuprint.com/isleepData?category=type&subcategory=reseller&metrics=billingCity`)
    //   .get(
    //     `${process.env.REACT_APP_BASE_URL}isleepData?category=${categoryValue}&subcategory=${subCategoryValue}&metrics=${subvalue}`
    //   )
    //   .then((res) => {
    //     console.log(res.data.message);
    //     let dataSeries = [];
    ...
    //       dataSeries.push(i.volume);
    //       labelData.push(String(i.labels||'undefined'));
    //     });

    //     setChartAllData({ dataSeries, labelData ,categoryValue,subCategoryValue,subvalue})
    //     ;}
    //   })
    //   .catch((error) => {
    //     console.log(error);
  ...
  const handleChartType = () => {
    if (!categoryValue || !subCategoryValue || !metricsValue) {
      ...
      console.log({ chartTypeData, category, subCategory, metrics })
      var chartObject = {
        ...
        chartDataSeries: chartAlldata?.dataSeries,
        // labelData: chartAlldata?.labelData,
        dataSeries: chartAlldata?.dataSeries,
  ...
  useEffect(() => {
    ...
    containers.forEach((container, containerIndex) => {
      ...
      var headBoxSize = $('.AllContainers').width();
      ...
      const containerResizeObserversTH = container.theadbox.map((box1, boxIndex1) => {
        const resizeObserverTH = new ResizeObserver((entries) => {
          const entry = entries[0];
          if (entry) {
            var { width } = entry.contentRect;
            width = (width * 100) / (headBoxSize - 8);
            ...
            updatedContainers[containerIndex].theadbox[boxIndex1] = updatedBox; // Update the box at the specified index
            setContainers(updatedContainers);
          }
        });
      ...
      const containerResizeObserversBH = container.bheadbox.map((box2, boxIndex2) => {
        const resizeObserverBH = new ResizeObserver((entries) => {
          ...
          if (entry) {
            ...
            updatedContainers[containerIndex].bheadbox[boxIndex2] = updatedBox;
            setContainers(updatedContainers);
          }
        });
    ...
    if (containers?.length) {
      ...
      containers?.map((container, containerIndex) => {
        container.theadbox.forEach((box, htIndex) => {
          ...
          var HeadlineTopBackground = document.getElementById(
        ...
        container.bheadbox.forEach((box, hbIndex) => {
          ...
          var HeadlineBottomBackground = document.getElementById(
      ...
      if (errorHeading === true) {
        ...
        axios
          .post(`${process.env.REACT_APP_BASE_URL}userRole/template`, {
            ...row,
            ...rowMain,
  ...
  const handleTemplateData = (value, name) => {
    setRow((prevState) => ({ ...prevState, [name]: value }));
  };
  ...
  return (
    <>
      ...
      <div className="card mb-2  dark:bg-black dark:text-white">
        <div
          className="card-header tw-bg-slate-300"
          style={{ justifyContent: "space-between" }}
        >
          <p>Create Template and Set Page Title</p>
          <Button
            onClick={handleSubmitTemplatePreview}
            variant="outlined"
            color="info"
          >
            Preview
          ...
          <div className="tw-flex tw-justify-between tw-flex-wrap">
            <div className=" tw-flex tw-flex-wrap tw-mb-6 tw-w-[32.50%]">
              <div className="tw-w-full">
                <label
                  className="tw-block uppercase tw-tracking-wide tw-text-gray-700 tw-text-xs tw-font-bold mb-2"
                ...
                <input
                  id="TemplateName"
                  autoFocus
                  className="tw-appearance-none form-control tw-block tw-w-full p-1  tw-text-gray-700 tw-border tw-border-gray-200 tw-rounded py-2 px-4  tw-leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                  type="text"
                  name="TemplateName"
            ...
            <div className="tw-flex tw-flex-wrap mb-6 tw-w-[32.50%]">
              <div className="tw-w-full">
                <label
            ...
            <div className="tw-flex tw-flex-wrap tw-mb-6 tw-w-[33.33%]">
              <div className="tw-w-full">
                <label
                ...
                <ReactQuill
                  theme="snow"
                  value={row?.pagetitlel}
                  name="pagetitlel"
                  onChange={(value) => handleTemplateData(value, "pagetitlel")}
                  id="pageTitlel"
            ...
            <div className="tw-flex tw-flex-wrap tw-mb-6 tw-w-[33.33%]">
              <div className="tw-w-full">
                ...
                <ReactQuill
                  theme="snow"
                  value={row?.pagetitlec}
                  name="pagetitlec"
                  onChange={(value) => handleTemplateData(value, "pagetitlec")}
                  id="pageTitle"
                  modules={{ toolbar: toolbarOptions }}
                ></ReactQuill>
              </div>
            ...
            <div className="tw-flex tw-flex-wrap tw-mb-6 tw-w-[33.33%]">
              <div className="tw-w-full">
                ...
                <ReactQuill
                  theme="snow"
                  id="pagetitler"
                  value={row?.pagetitler}
                  name="pageTitler"
                  onChange={(value) => handleTemplateData(value, "pagetitler")}
                  modules={{ toolbar: toolbarOptions }}
                ></ReactQuill>
              </div>
            </div>
      ...
      <div className="card  dark:bg-black dark:text-white">
        <div className="card-header">
          <button onClick={addContainer} className="add-more-container px-1">
          ...
          <ReactSortable shared list={containers} setList={setContainers}>
            {containers.map((container, containerIndex) => (
              <div
                ...
                className="AllContainers tw-mt-5 card"
              >
                <div
                  style={{ backgroundColor: "rgba(0, 0, 0, 0.03)" }}
                  className="tw-card-header tw-flex tw-justify-between tw-items-center tw-relative tw-bg-header p-2"
                >
                  <span
                ...
                <div className="card-body tw-flex ptemp tw-flex-wrap tw-relative containersBodys p-1">
                  ...
                  >
                    {container?.boxes?.map((box, boxIndex) => (
                      <div
                        ...
                        className="boxes tw-resize tw-overflow-auto border-1 tw-w-[100%] tw-h-[100%]"
                        data-show="1"
                      >
                        <div className="box-body">
                          <div className="box-header tw-relative">
                            <span
                              className="addChartBox"
                            ...
                            <span>
                              ...
                              <span
                                className="tw-cursor-pointer removeChartBox2"
      ...
      {/* Submit Template */}
      <div>
        <div className="mt-3 gap-x-2 justify-end flex">
          <Button
        ...
        <Box sx={styleMain}>
          <div>
            <Previews
              ...
              templateBackgroundTheme={rowMain}
      ...
      >
        <Box sx={style}>
          <div className="tw-w-full tw-bg-white tw-border-[1px]  tw-text-gray-900 tw-border-gray-300 tw-pb-5 demo">
            ...
            <div className="tw-grid tw-grid-cols-6 py-1 px-2 tw-gap-x-4 tw-sm:grid-cols-6">
              <div className="tw-col-span-2 p-2 tw-sm:col-start-1">
                <label
                  htmlFor="category"
                ...
                <div className="">
                  <select
                    ...
                    className="form-control tw-block tw-w-full p-1 tw-rounded-sm tw-border-0 py-0.5 tw-shadow-sm tw-ring-1 tw-ring-inset tw-ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-gray-400 sm:text-sm sm:leading-6"
                  >
                    <option value="">Select</option>
                    {category?.map((item, i) => {
                      return (
              ...
              <div className="tw-col-span-2 p-2 tw-sm:col-span-2">
                <label
                  htmlFor="SubCategory"
                  className="tw-text-medium tw-leading-6 tw-text-gray-900"
                >
              ...
              <div className="tw-col-span-2 p-2">
                <label
                  htmlFor="Metrics"
                  className="tw-text-medium tw-leading-6 tw-text-gray-900"
                >
          ...
          <div className="tw-w-full tw-bg-white tw-border-[1px] mt-3 tw-text-gray-900 tw-border-gray-300 pb-5 demo">
            <div className="tw-border-b-[1px] py-1 px-3 tw-bg-gray-50 tw-items-center tw-flex tw-justify-between">
              <span className="tw-text-xl tw-font-medium tw-leading-6">
                Select any chart
              </span>
          ...
          >
            ...
            <TabPanel value={value} index={4}>
              <sectiton
                id="selectChart5"
                className="selectChart tw-flex tw-flex-wrap gap-4"
              >
                <div className="tw-w-[320px]">
                  <input
                    type="radio"
          ...
          >
            ...
            <TabPanel value={value} index={0} style={{ width: "100%" }}>
              ...
              <div className="preview-content-box">
                <div className="tw-w-full tw-tw-flex mt-2 tw-py-1.5 tw-gap-x-10">
                  <div className="tw-flex py-2 tw-items-center tw-mt-1">
                    ...
                    <input
                      ...
                      className="c_input-text-title border-1"
                    />
                  </div>
                  <div className="tw-flex tw-flex-wrap tw-py-2 tw-items-center">
                    <p className="tw-mr-3">Box Title Color : </p>
                    <input
                      type="color"
                      name="Color"
                  ...
                  <div className="tw-flex tw-flex-wrap py-2 tw-items-center">
                  ...
                  <div class="containers">
                    ...
                    <label>
                      <input
                        ...
                        defaultChecked={DataLabels=='both'}
            ...
            <TabPanel value={value} index={6} style={{ width: "100%" }}>
              ...
              <div className="preview-content-box">
                ...
                <div className="tw-w-full tw-tw-flex mt-2 py-1.5">
